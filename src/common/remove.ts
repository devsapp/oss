import { globalParams, globalDescribe, assumeYesDescribe, regionDescribe } from './constant';
...
export const REMOVE = [
  ...
  {
    header: 'Document',
    content: '$  https://github.com/devsapp/oss/docs/zh/command/remove.md',
  },
  {
    header: 'Usage',
...
export const REMOVE_BUCKET = [
  {
    header: 'Remove bucket',
  ...
  {
    header: 'Usage',
    content: '$ s remove bucket <options>',
  },
  {
    header: 'Options',
    optionList: [regionDescribe, assumeYesDescribe],
  },
  { ...globalParams },
  { ...globalDescribe },
  {
    header: 'Examples with Yaml',
    content: ['$ s remove bucket'],
  },
  {
    header: 'Examples with CLI',
    content: ['$ s cli oss remove bucket --region cn-hangzhou --bucket-name ossbucket'],
  },
];
